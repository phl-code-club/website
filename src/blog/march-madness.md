---
title: 2026 PHL Code Club March Madness
...
PHL Club made its debut in the conference world through participating in the years [Diversitech](https://diversitech.tribaja.co/) Conference here in Philadelphia. On March 19th, Amaury, Christina, and Graham hopped on stage to deliver a workshop titled: "Logs, Traces, and Metrics, Oh My!" Through this talk, we helped professionals of various levels engage with creating an application for observability using OpenTelemetry.

For those of you who do know, Diversitech is a conference centered around increasing economic mobility for people of color. So glad we could do that and also spread a little bit of awareness about the [PostHog](http://posthog.com/) name while we were there!
...
Finally, for our normal event of the month, we collaborated with [Philly.rb](https://www.phillyrb.org/?utm_source=phlcodeclub) to provide an advent of code style treasure hunt. As per usual, we brought our PHL Code Club and PostHog swag to the event to give to participants.
